...
plt.tricontour( x_data, y_data, rho_data, norm = my_norm, colors = 'black', linewidths = 0.35, levels = np.arange( 0.0, 2.01, 7.5e-2 ) )
...
plt.tricontour( x_data, y_data, P_data, norm = my_norm, colors = 'black', linewidths = 0.35, levels = np.arange( 0.0, 2.01, 7.5e-2 ) )
